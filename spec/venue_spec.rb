...
describe Venue do
  ...
  describe 'is venue over capacity' do
    it 'determines if venue is over capacity' do
      venue = Venue.new('Bluebird', 4)
      venue.add_patron('Mike')
      venue.add_patron('Megan')
      venue.add_patron('Bob')
...
describe Venue do
  describe 'venue is over capacity' do
    it 'determines venue is over capacity' do
      venue = Venue.new('Bluebird', 4)
      venue.add_patron('Mike')
      venue.add_patron('Megan')
      venue.add_patron('Bob')
...
#require "pry"; binding.pry
  ...
  describe 'kick out' do
    it 'kicks out patrons when over capacity' do
      venue = Venue.new('Bluebird', 4)
      venue.add_patron('Mike')
      venue.add_patron('Megan')
      venue.add_patron('Bob')
