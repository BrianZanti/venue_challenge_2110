...
describe Venue do
  ...
  describe '#over_capacity' do
    it 'returns false if less patrons then capacity' do
    ...
    it 'returns true if more patrons then capacity' do
      venue = Venue.new('Bluebird', 4)
      venue.add_patron('Mike')
      venue.add_patron('Megan')
      venue.add_patron('Bob')
  ...
  describe '#kick_out' do
    it 'removes patrons from venue if over capacity' do
      venue = Venue.new('Bluebird', 4)
      venue.add_patron('Mike')
      venue.add_patron('Megan')
      venue.add_patron('Bob')
      venue.add_patron('James')
      venue.add_patron('Cat')
      expect(venue.over_capacity?).to eq 4
    end
  end
end
