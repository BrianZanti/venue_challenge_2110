...
describe Venue do
  ...
  describe '#yell_at_patrons' do
    it 'returns a list of uppercased patron names' do
      venue = Venue.new('Bluebird', 4)
      venue.add_patron('Mike')
      venue.add_patron('Megan')
      venue.add_patron('Bob')
  ...
  describe '#over_capacity?' do
    it 'returns false because venue is not over capacity' do
      venue = Venue.new('Bluebird', 4)
      venue.add_patron('Mike')
      venue.add_patron('Megan')
      venue.add_patron('Bob')
  ...
  describe '#over_capacity?' do
    it 'returns true because venue is over capacity' do
      venue = Venue.new('Bluebird', 4)
      venue.add_patron('Mike')
      venue.add_patron('Megan')
      venue.add_patron('Bob')
